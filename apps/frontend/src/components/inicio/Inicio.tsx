...
function Inicio() {
  return (
    <div className="h-[80vh] bg-blue-50 flex">
      <div className="container mx-auto grid grid-cols-2 space-x-3 items-center">
        <div className="mt-6">
          ...
          <div className="flex gap-4">
            <button className="px-8 py-4 bg-blue-600 text-white rounded-lg font-semibold hover:bg-blue-700 transition-colors text-lg whitespace-nowrap cursor-pointer">Começar Análise</button>
            <button className="px-8 py-4 bg-white text-slate-700 rounded-lg font-semibold hover:bg-slate-50 transition-colors text-lg border-2 border-slate-200 whitespace-nowrap cursor-pointer">Saiba Mais</button>
          </div>
        </div>
