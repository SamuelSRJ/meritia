    ...
    <div className="lg:h-[80vh] bg-blue-50 flex p-2 lg:p-0">
      <div className="container mx-auto grid grid-cols-1 lg:grid-cols-2 space-y-3 lg:space-x-3 items-center">
        <div className="mt-6 p-2 lg:p-0">
          ...
          <p className="text-lg lg:text-xl text-center lg:text-left text-slate-600 mb-8 leading-relaxed p-2 lg:p-0">Analise a compatibilidade do seu currículo com vagas de emprego usando IA avançada. Receba feedback detalhado sobre suas habilidades técnicas, soft skills e recomendações personalizadas.</p>
