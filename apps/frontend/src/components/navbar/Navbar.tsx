  ...
  return (
    <nav className="bg-white w-full">
      <div className="container flex flex-wrap items-center justify-between mx-auto py-4">
        <Link
          to={"/"}
          className="flex mx-auto lg:mx-1 items-center space-x-1 rtl:space-x-reverse"
        >
          <img
            src="/meritia.png"
            className="w-10 h-10 text-white p-1 rounded-sm"
          />
          <span className="text-3xl text-heading font-semibold whitespace-nowrap">
            Meritia
          </span>
        </Link>
        {/* {!user ? (
