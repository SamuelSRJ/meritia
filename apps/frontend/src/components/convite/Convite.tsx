  ...
  return (
    <div className="p-20">
      <div className="mx-auto px-4 text-center">
        ...
        <button className="px-10 py-4 bg-blue-600 text-white rounded-lg font-semibold hover:bg-blue-700 transition-colors text-lg whitespace-nowrap cursor-pointer inline-flex items-center gap-2">
